...
export default function Sidebar () {
  ...
  return (
    <div className={`absolute lg:relative w-full ${open ? 'lg:max-w-60' : 'lg:max-w-20'} lg:h-full transition-all duration-500`}>
      <div className={`relative z-40 flex flex-row-reverse lg:flex-row justify-between ${open ? '' : 'lg:justify-center'} p-6 bg-white lg:rounded-t-xl`}>
      ...
      <div className={`absolute z-30 top-0 pt-19 h-screen lg:h-full flex transition-discrete duration-500 w-full ${open ? 'left-0' : '-left-full lg:left-0'}`}>
        <div className="w-60 min-w-60 lg:min-w-full lg:w-full h-full border-r border-gray-200 relative bg-white lg:rounded-b-xl">
